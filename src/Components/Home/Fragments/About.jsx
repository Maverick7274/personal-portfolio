...
function About() {
  return (
    <div className='lg:pt-[0]'>
                <div className=' h-screen flex justify-center items-center lg:flex-row sm:flex-col flex-col gap-[2rem]'>
            <div className='lg:m-[4rem] sm:m-[2rem]'>
                <div className='bg-[rgba(255,255,255,0.6)] rounded-xl p-[1rem]'>
                    <img src={AboutImage} alt='Hero-Image' className="rounded-lg drop-shadow-2xl lg:w-[3000px] w-[200px]" />
                </div>
            </div>
            <div className='mx-[5rem]'>
                <h2 className="font-bold text-white text-center lg:text-left md:text-[2.7rem] lg:text-[3rem] sm:[3rem]">Who Am I?</h2>
                <div>
                    <p className="mt-6 lg:leading-6 md:leading-[1.2rem] leading-[1.4rem] lg:text-[1.2rem] sm:text-[1rem] text-[0.7rem] text-300">
                    ...
                    <p className="mt-6 hidden lg:block lg:leading-6 md:leading-[1.2rem] leading-[1.4rem] lg:text-[1.2rem] sm:text-[1rem] text-[0.7rem] text-300">
                    ...
                    <p class="mt-6 lg:leading-6 md:leading-[1.2rem] leading-[1.4rem] lg:text-[1.2rem] sm:text-[1rem] text-[0.7rem] text-300">
